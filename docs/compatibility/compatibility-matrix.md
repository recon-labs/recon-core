...
| Comparison execution placement | Planned; assigned across Milestones 7.2, 7.3, and 7.4 | Must be resolved before any typed plan execution. Row-count placement belongs to Milestone 7.2, key-check placement belongs to Milestone 7.3, and aggregate placement belongs to Milestone 7.4. No sub-milestone may silently fall back to Python, adapter dialect casts, inferred mappings, or unsupported comparison behavior. |
