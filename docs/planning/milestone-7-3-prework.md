...
| Bounded local/dev relation-backed fixture | May execute only when the internal scan guard classifies it as local, relation-backed, and bounded. | Add local/dev exception test. |
