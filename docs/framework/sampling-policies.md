...
deterministic hash or numeric modulo sampling until the sampling execution gate
is resolved.
...
sample-key state, and watermark-backed execution belong to later state work.
